...
const floppyAddress = "0x403C202C88eCA8e6C1FEC70dce71AdcB854eab16";
const myPrivKey = process.env.DEPLOYER_PRIV_KEY;
const myAddress = "0xD223dAec94a7C3c111593849829CA42A0e76d8b3";
const receiverAddress = "0x8Ca8d862890CB7A802Ea5da97b9D2f5d26674938";

async function interact() {
    const web3 = await new Web3(
        "https://data-seed-prebsc-1-s3.binance.org:8545/"
    );
    const floppyContract = await new web3.eth.Contract(
        floppyAbi,
        floppyAddress
    );
    ...
    const rs = await floppyContract.methods
        .transfer(receiverAddress, web3.utils.toWei("6"))
        .send({
            from: myAddress,
            gas: 300000,
        });
